...
public class GunScript : MonoBehaviour {
	...
	public float chargeAmmo;
	public HaveBurrets haveBurrets;
	...
	*/
	...
	void AmmoRefill()
    {
		if (AmmoShop.ammoShopState == AmmoShop.AmmoShopState.Buy)
		{
			bulletsIHave += chargeAmmo;
			if(bulletsIHave >= maxAmmo)
            {
				bulletsIHave = maxAmmo;
            }
			AmmoShop.ammoShopState = AmmoShop.AmmoShopState.Redy;
		}
	}
}
